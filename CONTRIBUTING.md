...
Generating code and explaining code with AI is a wonderful new way to engineer things. It's the next
step in gaining valuable insights into what we do. This project fully supports exploring, testing, and creating
ideas for how to solve a problem with AI! However, that comes with the responsibility that any programmer must fully
understand what the AI is doing to the extent that if they were to write it by hand they would write exactly the same
thing.

And if I may get opinionated for a moment; I think junior to mid level engineers should never use AI. Maybe for
answering a few questions
but never generating code to be used in a live system. If you don't get that hands on practice, you'll never learn,
you'll never
